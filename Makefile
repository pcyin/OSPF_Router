...
SOURCEFILES := Common.cpp HelloTimer.cpp Interface.cpp LSAManager.cpp LSDatabase.cpp main.cpp Neighbor.cpp PacketManager.cpp PacketRetransmitter.cpp RoutingTable.cpp StateMachine.cpp Timers.cpp

TARGETNAME := OSPF_Router
